        ...
        <blockquote className="text-center lg:mx-auto lg:w-3/5">
          ...
          <div className="">
            <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium ">
              ...
              <span className="relative z-10 my-custom-text">
                I love how this app makes scheduling so simple and keeps me organized without any hassle.
              </span>
            </p>
          </div>
          <footer className="mt-6">
            <div className="font-semibold italic">Sarthak Singh</div>
